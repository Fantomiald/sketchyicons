 ...
 */
export interface SketchyIconProps extends Omit<SVGProps<SVGSVGElement>, 'ref'> {
...
export type SketchyIcon = ForwardRefExoticComponent<
  SketchyIconProps & RefAttributes<SVGSVGElement>
>;
